...
class DetailItemState extends Equatable {
  ...
  const DetailItemState.empty()
      : this._(status: DetailItemStatus.empty, item: ItemModel.empty);

  const DetailItemState.success(ItemModel item)
      : this._(status: DetailItemStatus.success, item: item);
